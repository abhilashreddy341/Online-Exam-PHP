...
<p class="head1">Welcome to Admistrative page </p>
<div style="margin:auto;width:90%;height:500px;box-shadow:2px 1px 2px 2px #CCCCCC;text-align:left">
<div style="margin-left:20%;padding-top:5%">
<p class="style7"><a href="subadd.php">Add your Subject</a></p>
<p class="style7"><a href="testadd.php">Add your Test</a></p>
<p class="style7"><a href="questionadd.php">Add your Question </a></p>
