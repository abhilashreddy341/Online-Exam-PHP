...
{
extract($_POST);
mysql_query("insert into mst_question(test_id,que_desc,ans1,ans2,ans3,ans4,true_ans) values ('$testid','$addque','$ans1','$ans2','$ans3','$ans4','$anstrue')",$connection) or die(mysql_error());
...
<?php
$rs=mysql_query("Select * from mst_test order by test_name",$connection);
