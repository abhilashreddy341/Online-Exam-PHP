...
scale= showall>
    ...
    <td width="10%">
     <img border="0" src="image/upright.png" width="203" height="68" align="right"></td>
  </tr>
</table>
<table border="0" width="100%" cellspacing="0" cellpadding="0" bgcolor="#000000" background="img/bar.jpg">
  <tr>
    <td width="100%" align="right"><img border="0" src="image/bar.jpg" width="89" height="15"></td>
  </tr>
  </Table>
  <Table width="100%">
  <tr>
  ...
  ?>
	...
	{
	 echo "<div align=\"right\"><strong><a href=\"index.php\"> Home </a>|<a href=\"Logout.php\">Logout</a></strong></div>";
	 }
	 else
	 {
	 	echo "&nbsp;";
