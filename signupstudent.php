...
function check()
{
 ...
 if(document.form1.lid.value=="")
  {
    alert("Plese Enter Student Login Id");
...
?>
 <table width="100%" border="0">
   <tr>
     <td width="132" rowspan="2" valign="top"><span class="style8"><img src="image/userlogo.jpg" width="131" height="155"></span></td>
     <td width="468" height="57"><h1 align="center"><span class="style8">New Student Signup Page</span></h1></td>
   </tr>
   <tr>
     <td><form name="form1" method="post" action="signupuser.php" onSubmit="return check();">
       <table width="301" border="0" align="left">
         <tr>
           <td><div align="left" class="style7">Student Login Id </div></td>
         ...
         <tr>
           <td>&nbsp;</td>
           <td><input type="submit" name="Submit" value=" press for Signup">
           </td>
         </tr>
       </table>
     </form></td>
